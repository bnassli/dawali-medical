...
Reconciled in R1b (ADR-029), shown in visual groups: **Reason for visit / Problem List** (Reason for Visit, Problem List) · **Chief Complaints** (Chief Complaints, Associated condition, How long?, Symptoms getting worse over time? [checkbox, replaces the retired `progression` select], Affects daily living activities?, Additional Comments, Comment) · **Aggravating / Relieving Factors** · **Previous conservative therapy** (Previous Conservative Therapy, How long?) · **Family history** ("Family history of VV?", the shared `family_history`) · **Habits** (Alcohol, Exercise, Tobacco) · **Medications / Allergies** (Pain Meds for CC, Current Meds, Allergies).
